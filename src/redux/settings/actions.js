...
export const LoadUserTheme = (userTheme) => ({
  type: LOAD_USER_THEME,
  payload: userTheme,
});
export const LoadUserLanguage = (language) => ({
...
export const getMenuItemsSuccess = (menu_items) => ({
...
export const toggleShowCustomer = () => {
  return {
    type: TOGGLE_SHOW_CUSTOMERS,
  };
};
